					...
					<h3>Recover your account</h3>
						...
						<form name="retrieve_form" action="logic.php?val=activate" method="POST">
                                                 ...
                                                 <div id="erremail" class="alert-danger"></div>   
                                                    ...
                                                    <div>
                                                <input type="password" name="txtrepass" id="txtrepass" required onkeyup="checkPass(); return false;"/>
                      ...
                      <div> 
                          <button type="submit" name="submitbtn" id="submitbtn" class="btn btn-default" disabled="true">Submit</button><br></div>
