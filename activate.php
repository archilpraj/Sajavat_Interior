...
<head>
    ...
    <title>Restore Account :: Sajavat Interiors</title>
					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="mailto:info.sjinteriors@gmail.com"><i class="fa fa-envelope"></i> info.sjinteriors@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--middle form-->
						<h2>Recover your account</h2>
						<form name="retrieve_form" action="logic.php?val=activate" method="POST">
                                                 <div>
                                                    <span>Email:</span> <input type="text" name="txtemail" id="txtemail" onchange="chkmail()" required />
                                                    </div>
                                                    <div id="erremail" class="alert-danger"></div>
                                                    <div>
                                                    <span>Code</span><input type="text" name="txtcode" id="txtcode" required />
                                                    </div>
                                                    <div>
                                                    <span>Password: </span>
                                                    <input type="password" name="txtpass" id="txtpass" required/>
                                                    </div>
                                                    <div id="errrepass" class="alert-danger"></div>
                                                    <span>Confirm Password:</span>
                                                    <div>
                                                <input type="password" name="txtrepass" id="txtrepass" required onkeyup="checkPass(); return false;"/></div>
                                                    <div id="errcpassword" class="message-preview"></div>
                                                    
                                           <button type="submit" name="submitbtn" id="submitbtn" class="btn btn-default" disabled="true">Submit</button><br>
...
<!--					<div class="col-sm-2">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 Sajavat Interiors Inc. All rights reserved.</p>
