...
if (isset($_SESSION['user'])) {
    ...
    <html>
        <head>
            <title>Login ::Sajavat Interiors</title>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="account_grid">
                                    <div class="col-md-6 login-left">
                                        <h3>NEW CUSTOMERS</h3>
                                        <p>By creating an account with our store, you will be able to move through the checkout process faster, store shipping addresses, view your orders in your account and more.</p>
