...
$sql="select * from user where user_id='".$_SESSION['user']."'";
    ...
    <html>
        <head>
            <title>Sajavat Interiors | Payment</title>
...
<br>
                                <div class="account_grid">
                                    ...
                                    <center> <div class="col-md-6 login-right">
                                       <h3>Payment Mode</h3><br><br>
                                       &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <a href="cod.php"><input type="submit" value="Cash on Delivery" class="btn btn-default"/></a>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;
                                        <a href="netbanking.php"><input type="submit" value="Net-Banking" class="btn btn-default"/></a><br><br><br>
                                    </div></center> 
                                </div>	
                                <div class="clearfix"> </div>
                            </div>
