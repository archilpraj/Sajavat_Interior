                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">
                                    Bed <small>Add In Inventory</small>
                                </h1>
                                <ol class="breadcrumb">
                                    <li class="active">
                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><i class="fa fa-th fa-fw"></i> Add Bed</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form class = "form-horizontal" role = "form" action="add_update_del_logic.php?tab=bed" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="bed_type" class="form-control" style="width:300px;"><option>Queen</option><option>King</option><option>Single</option></select>
                                    </div>
                                </div>
