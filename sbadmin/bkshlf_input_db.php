                ...
                <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div>
                            ...
                            <form class = "form-horizontal" role = "form" action="add_update_del_logic.php?tab=bkshlf" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="floor_Standing" class="form-control" style="width:300px;"><option>Yes</option><option>No</option></select>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label">Storage Type</label>
                                        <select name="storage_type" class="form-control" style="width:300px;"><option>Open Storage</option><option>Open Storage,Drawer</option><option>Closed Storage</option><option>Open Storage,Closed Storage</option></select>
                                    </div>
                                </div>
                                <label><h3>Storage And Size</h3></label>
                                <div class="row">
                                    <div class="col-md-4">
