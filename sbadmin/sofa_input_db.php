                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">
                                    Sofa <small>Add In Inventory</small>
                                </h1>
                                <ol class="breadcrumb">
                                    <li class="active">
                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><i class="fa fa-th fa-fw"></i> Add Sofa</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form class = "form-horizontal" role = "form" action="add_update_del_logic.php?tab=bed" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4"><label class = "control-label">Product Id</label>
                                        <div class = "input-group">
                                            <span class="input-group-addon " id="basic-addon1">P_SOFA</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text"  name="colour" class="form-control" style="width:200px;" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="warranty" class="form-control" style="width:200px;" required>
                                    </div>
                                </div>
                                ...
                                <label><h3>Primary Material And Room Type</h3></label>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="control-label">Product Material Type</label>
                                        <select name="primary_material" class="form-control" style="width:300px;"><option>Sheesham Wood</option><option>Engineered Wood</option><option>Acacia Wood</option><option>Mango Wood</option><option>Teak Wood</option><option>Recycled Wood</option><option>Metal</option></select>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label">Room Type</label>
                                        <input type="text" name="room_type" class="form-control" style="width:200px;" required>
                                    </div>
                                    <div class="col-md-4">
                                    </div>
                                </div>
